...
from modules.discovery import (
    Discovery,
    CACHE_FILE,
    prepare_extractor_choices,
    build_extractor_dict,
)
...
class TestDiscovery(unittest.TestCase):
        ...
        cache_data = {
            ...
            "project": {
                ...
                "classifier_id": {
                    ...
                    "doc_type_ids": ["id_cards", "invoices"],
                },
                "extractor_ids": {
                    "id_cards": {"id": "id_cards", "name": "ID Cards"},
                    "invoices": {"id": "invoices", "name": "Invoices"},
                },
            },
        }
    ...
    def test_build_extractor_dict(self):
        ...
        cache = {"project": {"classifier_id": {"doc_type_ids": ["dt1", "dt2"]}}}
